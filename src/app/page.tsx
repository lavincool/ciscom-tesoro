  ...
  return (
    <div className="grid grid-rows-[10px_1fr_10x] items-center justify-items-center min-h-screen p-8 pt-0 pb-10 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-2 items-center m-auto mt-4">
        <h1 className="center text-center text-lg mb-4 mt-[-20px]">Capítulo de Ingenieria en Sistemas Computacionales <p className="font-semibold text-yellow-400 mt-6">~ Busqueda del tesoro ~</p></h1>
